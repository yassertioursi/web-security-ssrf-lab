            ...
            <div>
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <span class="text-sm text-gray-600">(3,142 reviews)</span>
                    </div>
                    ...
                    <div class="border-t border-b py-4 my-4">
                        <div class="flex items-baseline gap-2">
                            ...
                            <span class="bg-red-100 text-red-600 px-2 py-1 rounded text-sm font-semibold">20% OFF</span>
                        </div>
                    </div>
...
function checkStock() {
    ...
    fetch('/ssrf/blind/check-availability', {
        method: 'POST',
        headers: {
    ...
    .then(data => {
        if (data.available) {
            ...
            stockMessage.innerHTML = '<span class="text-yellow-600">⚠ ' + data.status + '</span>';
        }
    })
    .catch(error => {
