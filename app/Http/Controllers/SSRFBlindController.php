...
class SSRFBlindController extends Controller
{
    public function index()
    {
       $product = [
        ...
        return view('ssrf.blind', compact('product'));
    }
    ...
    private function handleGopher($url, $parsed)
    {
        ...
        if (!$socket) {
            return response()->json(['available' => false, 'message' => 'Connection failed'], 500);
        }
        ...
        return response()->json(['available' => true, 'message' => 'Request completed']);
    }
